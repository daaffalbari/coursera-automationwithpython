...
error_messages = {}
per_user = {}
logfile =r"/home/student-02-42a3689e851b/syslog.log"
...
sorted_users = [("student-02-42a3689e851b", "INFO", "ERROR")] + sorted(per_user.items())[0:8]
#sorted_users = [("student-02-42a3689e851b", "INFO", "ERROR")] + sorted(per_user.items())
